   ...
   <main className="h-screen bg-black">
        ...
        <div className='w-full h-full relative z-10 flex flex-col items-center justify-center bg-gradient-to-tl from-black via-zinc-600/20 to-black'>
            ...
            <div className='w-full text-center relative'>             
              <motion.h2 className='text-transparent bg-white text-edge-outline bg-clip-text whitespace-nowrap leading-none font-cal text-5xl md:text-7xl lg:text-9xl' initial={{opacity: 0, x: -100}} animate={{opacity: 1, x: 0}} transition={{delay: 0.1, duration: 1.5}}>Jakub Stranianek</motion.h2>
            </div>
