  ...
  return (
    <div>      
      ...
      <section className={'py-8 w-full fixed z-50 backdrop-blur duration-200 bg-zinc-900/500 border-b border-zinc-600'}>
        ...
        <Link href="/projects" alt="project"><ArrowLeftIcon className="relative z-20 w-8 text-zinc-400 hover:text-white" /></Link>
              <Link href={item.github} alt={item.github} target="_blank">              
                <svg width="20" height="20" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg" className="fill-zinc-400 hover:fill-white">
