        ...
        return (   
          ...
          <div key={item.id} className="w-full h-full bg-black bg-gradient-to-tl from-zinc-900/0 via-zinc-900 to-zinc-900/0">
            ...
            <section className='flex items-center justify-between'>
              <Link href="/projects"><ArrowLeftIcon className="relative z-20 w-8 text-zinc-400 hover:text-white" /></Link>
            ...
            <section className="py-20 flex flex-col gap-8 text-center">
